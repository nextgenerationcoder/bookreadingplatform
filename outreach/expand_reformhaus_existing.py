import openpyxl
wb = openpyxl.load_workbook('/home/user/bookreadingplatform/outreach/ginger_shoc_outreach_tracker.xlsx')
...
wb.save('/home/user/bookreadingplatform/outreach/ginger_shoc_outreach_tracker.xlsx')
print('done')

...
// Speech-to-text provider for the LessonPlayer mic button. Groq is the only
// provider (see server/src/asr.js) and needs the account's own key in
// asr_api_key_enc; NULL means the mic button isn't usable yet.
